...
export default function SubscriptionPlansPage() {
  ...
  const fetchClientSubscriptions = async () => {
    try {
      const response = await fetch('/api/superadmin/client-subscriptions');
      const result = await response.json();
      if (result.success) {
  ...
  const handleCreatePlan = async () => {
    try {
      ...
      const url = editingPlan ? '/api/superadmin/subscription-plans' : '/api/superadmin/subscription-plans';
